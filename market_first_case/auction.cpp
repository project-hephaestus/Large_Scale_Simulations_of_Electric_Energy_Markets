...
void auction::clear_market(void)
{
  ...
  if(type==0)
  {
		...
		sprintf(s8,"%f",current_frame.seller_total_quantity);
			printf("demand %f\n\n\n\n\n\n",current_frame.buyer_total_quantity);
		if(strcmp(OBJECTHDR(this)->name,"Market_1")!=1)
		{
			
				//int q1=rand()%(percentage-(-percentage))-percentage;
				sprintf(s9,"%f",current_frame.buyer_total_quantity-(current_frame.buyer_total_quantity*percentage)/100);
			    //sprintf(s9,"%f",1.10*7856);
			//	printf("%s\n\n\n\n\n\n",s9);
				counter1++;
			//	printf("demand %f\n\n\n\n\n\n",current_frame.buyer_total_quantity);
		...
		{
			//int q2=rand()%(percentage-(-percentage))-percentage;
			if(counter2<12)
			{
				sprintf(s9,"%f",current_frame.buyer_total_quantity-(current_frame.buyer_total_quantity*percentage)/100);
			}
		...
		{
			 //int q3=rand()%(percentage-(-percentage))-percentage;
			 sprintf(s9,"%f",current_frame.buyer_total_quantity+(current_frame.buyer_total_quantity*percentage)/100);
			//  sprintf(s9,"%f",1.10*5345);
			//   printf("%s\n\n\n\n\n\n",s9);
			   counter3++;
			  // printf("demand %f\n\n\n\n\n\n",current_frame.buyer_total_quantity);
	...
	/*	else if(strcmp(OBJECTHDR(this)->name,"Market_4")!=1)
		{
			   //int q4=rand()%(percentage-(-percentage))-percentage;
			if(counter4<12)
			{	
				sprintf(s9,"%d",current_frame.buyer_total_quantity+(current_frame.buyer_total_quantity*percentage)/100);
			}
			else
			{
			  sprintf(s9,"%d",current_frame.buyer_total_quantity-(current_frame.buyer_total_quantity*percentage)/100);
		...
		//	printf("%s\n\n\n\n\n\n",s9);
			...
			//new quanttiy for town factory close to demand
		//	if(current_frame.buyer_total_quantity+(prosimo)*(current_frame.buyer_total_quantity*(percentage))/100 > max_capacity)
		//	{
		//	     sprintf(s9,"%f",max_capacity);
		//	}
		//	else
		//	{
		      //   sprintf(s9,"%f",past_frame.buyer_total_quantity+(prosimo)*(past_frame.buyer_total_quantity*(percentage))/100);
		//	}
	    
		gl_set_value_by_name(bidder,"quantity",s9);
	printf("\n\n\n\n\n\n  supply: %s demand :%f clearing %f \n\n\n\n\n",s6,current_frame.buyer_total_quantity,current_frame.clearing_quantity);
		/*condition A*/
