...
TIMESTAMP controller::sync(TIMESTAMP t0, TIMESTAMP t1){
	...
	//NEW CONFIGURATION//
	char d_demand[20];
	OBJECT *house_parent=gl_get_object(parent_object->name);
	OBJECT *meter_parent=gl_get_object(house_parent->parent->name);
	double *total_demand=gl_get_double_by_name(meter_parent,"measured_demand");
